 ...
 */
export default function StoreBadges({ availableIn }: { availableIn: string }) {
  return (
    <div className="v-stores">
      <div className="v-store-row">
        <span className="v-store">
          ...
          <span><small>{availableIn}</small><b>Google Play</b></span>
        </span>
        <span className="v-store">
          ...
          <span><small>{availableIn}</small><b>App Store</b></span>
        </span>
      </div>
    </div>
  );
