        ...
        <div className="v-wrap pa-story">
          <div className="pa-story-text">
            ...
            <p>
              ...
              (CUHK), второй — МГИМО, бакалавриат «Информационные технологии в международном бизнесе». Сети и то,
              что с ними делают люди и государства, интересовали обоих.
            </p>
            <p>
              Осенью {STORY_YEAR} года, когда один из нас учился в Гонконге, обе половины проблемы стало видно
              одновременно. 28 сентября материковый Китай закрыл Instagram — из-за фотографий с гонконгских улиц.
              А за полторы недели до этого по мессенджерам разошлась ссылка на «приложение для координации»
              Code4HK: у тех, кто его поставил, чужие люди читали переписку, список контактов, историю звонков и
              видели точку на карте. Людей одним движением отключили от мира — и в тот же момент прочитали.
            </p>
            <p>
              Отсюда правило, с которым мы живём: доступ без защиты — половина дела, защита без доступа — вторая
              половина. Порознь они не работают.
            </p>
            <p>
              Первое, что мы собрали, было проще некуда: подключение, которое открывало заблокированный сайт, — для
              себя и знакомых. Потом появился небольшой магазин сетевого оборудования и цифровых товаров. Он кормил
              команду и научил тому, чего нет в спецификациях: люди платят за понятную вещь, которая работает без
              инструкции.
            </p>
            <p>
              Дальше были инвестиции, несколько заходов, которые ничем не кончились, и ещё один раунд. К нему мы
              вернулись к той же мысли {STORY_YEAR} года — и в {FOUNDED} году зарегистрировали Atlas Secure в
          ...
          <ol className="pa-story-line">
            <li>
              <b>{STORY_YEAR}</b>
              <span>
                Гонконг. Сайты закрывают, телефоны читают. Повод, из которого выросло всё остальное.
              </span>
            </li>
            <li>
              <b>{FOUNDED}</b>
              <span>Компания зарегистрирована. Двое основателей и одно подключение — открыть заблокированный сайт.</span>
            </li>
            <li>
              <b>Дальше</b>
              <span>
                Магазин оборудования и цифровых товаров, инвестиции, неудачные заходы и новый раунд — на него и
                собрали сервис.
              </span>
            </li>
            <li>
