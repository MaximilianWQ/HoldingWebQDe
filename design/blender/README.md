...
> **С 19.09.2026 кадр на сайте не используется**: владелец снял его с
> главной («сами рендеры не к месту»). Файлы и сборка сцены оставлены
> целиком — вернуть можно одной строкой в `components/vps/Home.tsx`,
