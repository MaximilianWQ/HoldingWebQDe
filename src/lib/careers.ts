 ...
 *
 * ОГОВОРКА ПРО СЛОВО «VPN». На витрине оно не употребляется (CLAUDE.md,
 * «Два языка продукта»), но страница найма разговаривает с инженерами:
 * прятать от сетевого инженера, с чем он будет работать, — значит
 * получать не тех кандидатов. Поэтому в тегах вакансий слово есть, как
 * на макете владельца, а в метаданных страницы и structured data —
 * нет.
 */
...
export const VACANCIES: Vacancy[] = [
  ...
  },
  {
    ...
    from: 180,
    to: 280,
    tags: ["хостинг и VPN-инфраструктура", "CI/CD", "мониторинг"],
    ...
    plus: [
      "Опыт с VPN-протоколами и сетевыми сервисами под нагрузкой",
