...
(async () => {
  ...
  await p.addStyleTag({ content: 'nextjs-portal, .b-top, .ak-tabbar, [class*="ios-sheet"], [class*="ov-"], .vc-qr, .vc-fine code { display: none !important; } *{animation-play-state:paused!important}' });
