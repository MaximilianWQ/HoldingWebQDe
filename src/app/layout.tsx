...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      // Формулировки «открывает заблокированное» на витрине нет
      // намеренно (19.09.2026): реклама средств обхода ограничений в
      // РФ запрещена, и в январе 2026 ФАС вынесла первое решение по
      // такой рекламе. Продукт описывается тем, что он даёт каждый
      // день: скоростью, стабильностью и защитой соединения.
      "Быстрое соединение, шифрование трафика и выбор страны в приложении. " +
