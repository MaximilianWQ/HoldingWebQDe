        ...
        <div className="v-wrap pa-story">
          ...
          <ol className="pa-story-line">
            ...
            <li>
              ...
              <span>Собрали для себя и знакомых — защищённый канал вместо чужого Wi-Fi. Спрос оказался больше.</span>
            </li>
            <li>
              <b>{FOUNDED}</b>
        ...
        <div className="v-wrap">
          ...
          <div className="pa-make">
            <Link href="/pricing" className="v-card v-card-pad pa-make-card v-lift">
              ...
              <p className="v-text">
                Для телефона и компьютера: сайты, видео и приложения работают на полной скорости.
              </p>
